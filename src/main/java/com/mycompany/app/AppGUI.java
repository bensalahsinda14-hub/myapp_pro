...
public class AppGUI {
    ...
    private JTextField tfPlaignant, tfDefendeur, tfEmail, tfCIN;
    ...
    private void initCenterPanel() {
        ...
        initFormPanel(center);
        initListPanel(center);

        frame.add(center, BorderLayout.CENTER);
    }

    private void initFormPanel(JPanel parent) {
        ...
        JScrollPane descScroll = new JScrollPane(taDescription, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    private void initListPanel(JPanel parent) {
    ...
    private void initActions() {
        ...
        btnVoir.addActionListener((ActionEvent e) -> {
            ...
            if (sel >= 0) {
                ...
                ta.setFont(new Font(FONT_DEFAULT, Font.PLAIN, 13));
    ...
    private static class CardRenderer extends JPanel implements ListCellRenderer<String> {
        ...
        CardRenderer() {
            ...
            label.setFont(new Font(FONT_DEFAULT, Font.PLAIN, 14));
