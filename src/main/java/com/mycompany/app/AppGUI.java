    ...
    public AppGUI() {
        ...
        btnVoir.addActionListener(e -> {
            ...
            if (sel >= 0) {
                ...
                ta.setEditable(false); ta.setBackground(null); ta.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        btnSupprimer.addActionListener(e -> {
            ...
            if (sel >= 0) {
                ...
                if ("1234".equals(code)) { storage.remove(sel); listModel.remove(sel); JOptionPane.showMessageDialog(frame, "✅ Demande supprimée."); }
